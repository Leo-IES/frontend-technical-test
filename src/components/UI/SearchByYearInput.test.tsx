...
describe("<SearchByYearInput />", () => {
    ...
    test("allows input of a year and triggers search", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith(titleReducer.filterByYearTitles(2022));
    });
    ...
    test("clean search button resets the input and dispatches action", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith(titleReducer.cleanFilterByYearTitles());
    });
    ...
    test("does not dispatch search action with invalid year", () => {
        ...
        expect(titleReducer.filterByYearTitles).not.toHaveBeenCalledWith(Number(invalidYear));
    });
});
//